...
export default function Sidebar({ views, current, onSelect }) {
  ...
  // Track which group is currently active as we iterate
    ...
    <nav className="sidebar">
      ...
      <ul className="nav-list">
        {views.map((v, i) => {
          ...
          // Find the sep for this item's group to check collapsed state
